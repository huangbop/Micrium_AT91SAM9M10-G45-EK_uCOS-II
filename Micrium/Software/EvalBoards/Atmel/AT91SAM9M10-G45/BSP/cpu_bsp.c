...
void  CPU_TS_TmrInit (void)
{
    ...
    CSP_TmrCfg(CSP_TMR_NBR_00, 0u);                             /* Configure Timer 0 as free running counter.           */
    CSP_TmrStart(CSP_TMR_NBR_00);                               /* Start Timer 0.                                       */
    
    CPU_TS_TmrFreqSet((CPU_TS_TMR_FREQ)clk_freq);
}    
#endif
...
CPU_TS_TMR  CPU_TS_TmrRd (void)
{
    ...
    ts_tmr_cnts = CSP_TmrRd(CSP_TMR_NBR_00);
